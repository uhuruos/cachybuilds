...
%install
install -D -m644 board-2-surface.bin "%{buildroot}%{_firmware_path}/ath10k/QCA6174/hw3.0/board-2-surface.bin"
...
- Use proper board-2-surface.bin file created by Hans de Goede
